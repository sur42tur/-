...
"border-radius:20px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "自用抽卡机"))
        self.comboBox.setItemText(0, _translate("MainWindow", "角色活动祈愿"))
        self.label_18.setText(_translate("MainWindow", "   点击可。。点了也没用"))
        ...
        self.label_16.setText(_translate("MainWindow", "陈晖洁我老婆!"))
        self.label_17.setText(_translate("MainWindow", "陈晖洁Surtr甘雨白露青雀可爱捏"))
        self.label_14.setText(_translate("MainWindow", "<html><head/><body>"
                                                        "<p style='line-height: 1.25;'>"
                                                        "每一抽都当做最后一抽，然后就也不要怕歪<br/>"
                                                        "三！二！一！加油！"
                                                        "</p></body></html>"))
        self.pushButton_3.setText(_translate("MainWindow", "商城"))
        self.label.setText(_translate("MainWindow", "还没抽到？快来"))
        self.pushButton.setText(_translate("MainWindow", "一发入魂"))
        self.pushButton_2.setText(_translate("MainWindow", "十连绝世"))
        self.label_11.setText(_translate("MainWindow", "9999999"))
        self.label_13.setText(_translate("MainWindow", "9999999"))
        self.plainTextEdit.setPlainText(_translate("MainWindow", "抽卡改变人生\n"
"---------------"))
        ...
        self.pushButton_4.setText(_translate("MainWindow", "返回抽卡"))
import res_rc
